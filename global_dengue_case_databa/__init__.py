...
def load_data(f=None):
  rid="https://juanmoisesd.github.io/global-dengue-case-database-by-country-1995-2024/".split(".")[-1];m=requests.get("https://zenodo.org/api/records/"+rid,timeout=30).json();csvs=[x for x in m.get("files",[]) if x["key"].endswith(".csv")]
...
def cite():return "de la Serna, Juan Moisés (2025). Database of confirmed and reported dengue cases in 31 countr"
